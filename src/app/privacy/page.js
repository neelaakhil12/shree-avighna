  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-stone-900 rounded-3xl p-8 text-white text-center mt-12">
          <h3 className="text-2xl font-bold mb-4">Questions about your privacy?</h3>
          <p className="text-stone-400 mb-6 max-w-md mx-auto">Our team is here to help you understand how we protect your data at Shree Avigna.</p>
