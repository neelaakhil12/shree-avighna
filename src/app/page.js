...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-20 pb-20">
      ...
      {/* Benefits Section */}
      <section className="bg-stone-50 py-20" id="benefits">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-stone-50 p-8 rounded-3xl border border-stone-200">
            ...
            <p className="text-stone-600 text-sm mb-6 leading-relaxed">
              Your privacy is our priority. We collect only necessary information to process your orders and improve our service.
            </p>
              ...
              {showPrivacy && (
                ...
                >
                  <div className="flex items-start gap-3">
                    <EyeIcon className="w-5 h-5 text-secondary shrink-0 mt-1" />
                    <p className="text-xs text-stone-500">We use your info solely for order processing and opted-in updates.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <LockClosedIcon className="w-5 h-5 text-secondary shrink-0 mt-1" />
                    <p className="text-xs text-stone-500">Secure servers and trusted payment gateways protect your data.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            >
              Read Full Policy <ArrowRightIcon className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="bg-stone-50 p-8 rounded-3xl border border-stone-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-stone-900">Terms of Service</h2>
            </div>
            <p className="text-stone-600 text-sm mb-6 leading-relaxed">
              By using Shree Avigna, you agree to our terms. Our products are 100% natural with specific storage requirements.
            </p>
            ...
            <AnimatePresence>
              {showTerms && (
                ...
                >
                  <div className="flex items-start gap-3">
                    <ScaleIcon className="w-5 h-5 text-secondary shrink-0 mt-1" />
                    <p className="text-xs text-stone-500">Acceptance of terms is required for using our website and services.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <ExclamationTriangleIcon className="w-5 h-5 text-secondary shrink-0 mt-1" />
                    <p className="text-xs text-stone-500">Natural variations in color and aroma are normal for wood-pressed oils.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <Link 
              ...
              className="text-secondary font-bold text-sm hover:underline flex items-center gap-1"
            >
              Read Full Terms <ArrowRightIcon className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
